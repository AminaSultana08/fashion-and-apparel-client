  ...
  const handleLoginGithub = ()=>{
    ...
    return (
       ...
       { <div className="bg-[url(https://i.ibb.co/2tQ5j4d/woman-feminine-lifestyle-shopping-fashionista-with-marble-background.jpg)] bg-cover h-screen bg-no-repeat">
        ...
        <input className="text-sm lg:w-full md:w-full w-80 mx-8 md:mx-0   px-4 py-2 border border-solid border-gray-300 rounded mt-4" type="password" name="password" placeholder="Password"  />

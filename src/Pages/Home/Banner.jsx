...
const Banner = () => {
    return (
        ...
        <div id="slide1" className="carousel-item  bg-black  w-full relative bg-gradient-to-tr from-gray-500 to-gray-900  ">
          <img src="https://i.ibb.co/Fqvmmgz/young-woman-model-blue-winter-jacket.jpg" className="w-full  h-full object-cover absolute mix-blend-overlay" />
          <div className='p-20 '>
